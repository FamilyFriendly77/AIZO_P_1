...
\begin{document}
  ...
  \section{Wprowadzenie}
    ...
    \subsection{Charakterystyka danych badawczych}
      ...
      dla algorytmu sortowania przez kopcowanie przeprowadzono także badanie stosując liczby zmiennoprzecinkowe (float, 4 bajty), liczby zmiennoprzecinkowe podwójnej precyzji (double, 8 bajtów), oraz znaki ASCII (char, 1 bajt).
  ...
  \section{Warunki badawcze}
    ...
    W Tab. \ref{tab:instancje} przedstawiono parametry wykorzystanych instancji badawczych do badania wydajności wszystkich
    algorytmów oraz do badania wpływu doboru elementu osiowego w algorytmie sortowania szybkiego, a w Tab. \ref{tab:instancje2} przedstawiono dodatkowe zestawienie instancji dla algorytmu
    sortowania przez kopcowanie przeznaczone do badania wpływu typu danych na czas sortowania tablicy.
